...
const ESTADO_BADGES = {
  ...
  'En Negociación': { label: 'En Negociación', emoji: '🤝', bg: 'bg-orange-50 dark:bg-orange-950/50', text: 'text-orange-700 dark:text-orange-300', border: 'border-orange-200 dark:border-orange-800' },
